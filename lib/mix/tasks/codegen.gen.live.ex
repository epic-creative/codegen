defmodule Mix.Tasks.Codegen.Gen.Live do
  ...
  with their respective names and types. See `mix codegen.gen.schema`
  ...
  in your applications `:generators` configuration. When set, the Codegen
  ...
  Alternatively, the `--context-app` option may be supplied to the generator:
      ...
      mix codegen.gen.live Sales User users --context-app warehouse
  ...
  module name, for example:
      ...
      mix codegen.gen.live Sales User users --web Sales
  ...
  use binary ids for primary keys, see `mix codegen.gen.schema` for more
  information.
  """
  use Mix.Task

  alias Mix.Codegen.{Context}
  alias Mix.Tasks.Codegen.Gen

  @doc false
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise "mix codegen.gen.live can only be run inside an application directory"
    end
  ...
  defp copy_new_files(%Context{} = context, binding, paths) do
    ...
    Mix.Codegen.copy_from(paths, "priv/templates/codegen.gen.live", binding, files)
  ...
  defp maybe_inject_helpers(%Context{context_app: ctx_app} = context) do
    web_prefix = Mix.Codegen.web_path(ctx_app)
  ...
  defp do_inject_helpers(context, file, file_path, inject) do
    ...
    new_file = String.replace(file, "import Codegen.LiveView.Helpers", "import Codegen.LiveView.Helpers\n      #{inject}")
    if file != new_file do
      File.write!(file_path, new_file)
    else
      Mix.shell().info """

      Could not find Codegen.LiveView.Helpers imported in #{file_path}.

      This typically happens because your application was not generated
      with the --live flag:

          mix codegen.new my_app --live
  ...
  def print_shell_instructions(%Context{schema: schema, context_app: ctx_app} = context) do
    ...
    web_path = Mix.Codegen.web_path(ctx_app)
    ...
    if schema.web_namespace do
      ...
      Add the live routes to your browser scope in #{Mix.Codegen.web_path(ctx_app)}/router.ex:
