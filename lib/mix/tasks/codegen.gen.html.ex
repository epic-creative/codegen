defmodule Mix.Tasks.Codegen.Gen.Html do
  @shortdoc "Generates controller, views, and context for an HTML resource"

  @moduledoc """
  Generates controller, views, and context for an HTML resource.

      mix codegen.gen.html Accounts User users name:string age:integer
  ...
  Alternatively, the `--context-app` option may be supplied to the generator:
      ...
      mix codegen.gen.html Sales User users --context-app warehouse
  ...
  module name, for example:
      ...
      mix codegen.gen.html Sales User users --web Sales
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise "mix codegen.gen.html can only be run inside an application directory"
    end
  ...
  def copy_new_files(%Context{} = context, paths, binding) do
    ...
    Mix.Codegen.copy_from(paths, "priv/templates/codegen.gen.html", binding, files)
  ...
  def print_shell_instructions(%Context{schema: schema, context_app: ctx_app} = context) do
    if schema.web_namespace do
      ...
      Add the resource to your #{schema.web_namespace} :browser scope in #{Mix.Codegen.web_path(ctx_app)}/router.ex:
      ...
      Add the resource to your browser scope in #{Mix.Codegen.web_path(ctx_app)}/router.ex:
