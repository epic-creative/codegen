defmodule Mix.Tasks.Codegen.Gen.Embedded do
  ...
  Generates an embedded Ecto schema for casting/validating data outside the DB.
      ...
      mix codegen.gen.embedded Blog.Post title:string views:integer
  ...
  the type makes it default to `:string`:
      ...
      mix codegen.gen.embedded Blog.Post title views:integer

  The following types are supported:

  #{for attr <- Mix.Codegen.Schema.valid_types(), do: "  * `#{inspect attr}`\n"}
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise "mix codegen.gen.embedded can only be run inside an application directory"
    end
  ...
  def raise_with_help(msg) do
    ...
    mix codegen.gen.embedded expects a module name followed by
    any number of attributes:

        mix codegen.gen.embedded Blog.Post title:string
    """
  end
  ...
  def copy_new_files(%Schema{} = schema, paths, binding) do
    ...
    Mix.Codegen.copy_from(paths, "priv/templates/codegen.gen.embedded", binding, files)
