defmodule Mix.Tasks.Codegen.Gen.Context do
  ...
  Generates a context with functions around an Ecto schema.
      ...
      mix codegen.gen.context Accounts User users name:string age:integer
  ...
  a `--table` option may be provided. For example:
      ...
      mix codegen.gen.context Accounts User users --table cms_users
  ...
  Read the documentation for `codegen.gen.schema` for more information on
  attributes.
  """
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise "mix codegen.gen.context can only be run inside an application directory"
    end
  ...
  defp inject_schema_access(%Context{file: file} = context, paths, binding) do
    unless Context.pre_existing?(context) do
      Mix.Generator.create_file(file, Mix.Codegen.eval_from(paths, "priv/templates/codegen.gen.context/context.ex", binding))
    end

    paths
    |> Mix.Codegen.eval_from("priv/templates/codegen.gen.context/#{schema_access_template(context)}", binding)
  ...
  defp inject_tests(%Context{test_file: test_file} = context, paths, binding) do
    unless Context.pre_existing_tests?(context) do
      Mix.Generator.create_file(test_file, Mix.Codegen.eval_from(paths, "priv/templates/codegen.gen.context/context_test.exs", binding))
    end

    paths
    |> Mix.Codegen.eval_from("priv/templates/codegen.gen.context/test_cases.exs", binding)
  ...
  defp inject_test_fixture(%Context{test_fixtures_file: test_fixtures_file} = context, paths, binding) do
    unless Context.pre_existing_test_fixtures?(context) do
      Mix.Generator.create_file(test_fixtures_file, Mix.Codegen.eval_from(paths, "priv/templates/codegen.gen.context/fixtures_module.ex", binding))
    end

    paths
    |> Mix.Codegen.eval_from("priv/templates/codegen.gen.context/fixtures.ex", binding)
  ...
  def raise_with_help(msg) do
    ...
    mix codegen.gen.html, codegen.gen.json, codegen.gen.live, and codegen.gen.context
    ...
    For example:
        ...
        mix codegen.gen.html Accounts User users name:string
        mix codegen.gen.json Accounts User users name:string
        mix codegen.gen.live Accounts User users name:string
        mix codegen.gen.context Accounts User users name:string
