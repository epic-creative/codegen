defmodule Mix.Tasks.Codegen.Gen.Schema do
  @shortdoc "Generates an Ecto schema and migration file"

  @moduledoc """
  Generates an Ecto schema and migration.

      mix codegen.gen.schema Blog.Post blog_posts title:string views:integer
  ...
  the CLI.
      ...
      # Via CLI
      mix codegen.gen.schema Blog.Post blog_posts title:string views:integer --context-app marketing
  ...
  the type makes it default to `:string`:
      ...
      mix codegen.gen.schema Blog.Post blog_posts title views:integer
  ...
  referenced table:
      ...
      mix codegen.gen.schema Blog.Post blog_posts title user_id:references:users
  ...
  type of the underlying array element to be given too:
      ...
      mix codegen.gen.schema Blog.Post blog_posts tags:array:string

  Unique columns can be automatically generated by using:

      mix codegen.gen.schema Blog.Post blog_posts title:unique unique_int:integer:unique
  ...
  a `--table` option may be provided. For example:
      ...
      mix codegen.gen.schema Blog.Post posts --table cms_posts
  ...
  def raise_with_help(msg) do
    ...
    mix codegen.gen.schema expects both a module name and
    the plural of the generated resource followed by
    any number of attributes:

        mix codegen.gen.schema Blog.Post blog_posts title:string
    """)
  end
